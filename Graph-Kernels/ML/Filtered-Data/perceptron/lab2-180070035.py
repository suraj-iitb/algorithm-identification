...
if __name__ == '__main__':
	...
	###Plotting samples vs error = 1-accuracy
    nums = [10,100,1000,10000,50000,80000]
    errors = []
    for i in nums:
        ...
        perceptron.train(X_train, Y_train)
        errors += [1 - perceptron.eval(X_test, Y_test)]
	#print(errors[-1])
