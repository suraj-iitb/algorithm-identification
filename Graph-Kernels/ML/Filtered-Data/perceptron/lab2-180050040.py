...
class Perceptron():
    ...
    def pred(self, x):
        ...
        return np.argmax(np.matmul(weg,res),axis=0)
        ### END TODO
...
if __name__ == '__main__':
    ...
    num_train_sample = [10, 100, 1000, 10000, 50000, 80000]
    plot_err = []
    X_train0, Y_train0, X_test0, Y_test0 = get_data('D1',1000)
    for i in num_train_sample:
        print("num_train_sample : ",i)
