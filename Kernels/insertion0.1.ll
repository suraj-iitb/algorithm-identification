; ModuleID = 'insertion0.1.cpp'
source_filename = "insertion0.1.cpp"
...
@__const.main.arr = private unnamed_addr constant [5 x i32] [i32 12, i32 11, i32 13, i32 5, i32 6], align 16
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_insertion0.1.cpp, i8* null }]
...
define dso_local void @_Z13insertionSortPii(i32* %0, i32 %1) #4 {
...
define dso_local void @_Z10printArrayPii(i32* %0, i32 %1) #5 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
...
define dso_local i32 @main() #6 {
  ...
  call void @_Z13insertionSortPii(i32* %5, i32 %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_insertion0.1.cpp() #0 section ".text.startup" {
